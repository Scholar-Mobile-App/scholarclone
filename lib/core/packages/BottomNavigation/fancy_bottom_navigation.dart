...
import 'package:scholar_clone/core/packages/BottomNavigation/internal/tab_item.dart';
import 'package:scholar_clone/core/packages/BottomNavigation/paint/half_clipper.dart';
import 'package:scholar_clone/core/packages/BottomNavigation/paint/half_painter.dart';
...
class FancyBottomNavigationState extends State<FancyBottomNavigation>
  ...
  Widget nextWidget = const Icon(Icons.search);
  Widget activeWidget = const Icon(Icons.search);
  ...
  void didChangeDependencies() {
    ...
    activeWidget = widget.tabs[currentSelected].sectedicon!;
  ...
  _setSelected(UniqueKey key) {
    ...
    if (mounted) {
      setState(() {
        ...
        nextWidget = widget.tabs[selected].sectedicon!;
      });
    }
  }
...
class TabData {
  TabData({this.icon, this.sectedicon, this.title, this.onclick});
