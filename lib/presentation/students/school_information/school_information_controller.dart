...
class SchoolInformationController extends GetxController {
  Content data = Get.arguments[0];
  Map<String, dynamic> userInfo = Get.arguments[1];

  Map<String, dynamic> resJson = {};

  RxList<AboutUs> schoolInformationList = <AboutUs>[].obs;
  ...
  callService() async {
    ...
    if (resJson[CS.status].toString() == StatusCode.Success) {
      ...
      schoolInformationList.value += model.data!;
