...
class AcadamicActivityController extends GetxController {
  Content data = Get.arguments[0];
  Map<String, dynamic> userInfo = Get.arguments[1];

  Map<String, dynamic> resJson = {};

  RxList<AboutUs> acadamicActivityList = <AboutUs>[].obs;
  ...
  callService() async {
    ...
    if (resJson[CS.status].toString() == StatusCode.Success) {
      ...
      acadamicActivityList.value += model.data!;
