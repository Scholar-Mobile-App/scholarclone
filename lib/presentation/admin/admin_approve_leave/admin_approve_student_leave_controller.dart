...
class AdminApproveStudentLeaveController extends GetxController {
  @override
  void onInit() {
    callService();
    super.onInit();
  ...
  Future<void> callService() async {
    ...
    if (await CU.checkInternet()) {
      resJson = await ApiClient.call(
        Get.context!,
        body: body,
        apiUrl: "https://erp.triz.co.in/get_adminLeaveApplicationListAPI",
  ...
  Future<void> callServiceReply(StudentLeaves lstData, String status) async {
    ...
    if (await CU.checkInternet()) {
      resJson = await ApiClient.call(
        Get.context!,
        body: body,
        apiUrl: "https://erp.triz.co.in/add_adminLeaveApplicationSaveAPI",
        isShowProgressDialog: false,
      );
    } else {
