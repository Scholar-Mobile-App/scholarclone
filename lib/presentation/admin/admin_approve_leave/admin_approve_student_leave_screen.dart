...
import 'admin_approve_student_leave_controller.dart';

class AdminApproveStudentLeaveScreen extends StatelessWidget {
  AdminApproveStudentLeaveScreen({super.key});
  final AdminApproveStudentLeaveController _controller =
      Get.put(AdminApproveStudentLeaveController());
