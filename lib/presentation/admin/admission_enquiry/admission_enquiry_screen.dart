...
class AdmissionEnquiryScreen extends StatelessWidget {
  AdmissionEnquiryScreen({super.key});
  final AdmissionEnquiryController _con = Get.put(AdmissionEnquiryController());
    ...
    return Scaffold(
        ...
        actions: <Widget>[
          Column(
            ...
            children: [
              GestureDetector(
                onTap: () => Get.toNamed(
                  AppRoutes.createAdmissionEnquiry,
                  arguments: [
                    _con.data,
                    _con.userInfo,
                    false,
      ...
      body: Obx(
        () => _con.isLoading.value
            ...
            : _con.admissionEnquiryList.isEmpty
                ? CU.getNodataDesign()
                : ListView.separated(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 20, vertical: 20),
                    itemCount: _con.admissionEnquiryList.length,
                    separatorBuilder: (context, index) => hSizeBox16,
                    itemBuilder: (context, index) {
                      var admissionConfirmation =
                          _con.admissionEnquiryList[index];
                      return Container(
