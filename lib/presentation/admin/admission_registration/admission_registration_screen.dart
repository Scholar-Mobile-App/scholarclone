...
import 'admission_registration_controller.dart';

class AdmissionRegistrationScreen extends StatelessWidget {
  AdmissionRegistrationScreen({super.key});
  final AdmissionRegistrationController _con =
      Get.put(AdmissionRegistrationController());
    ...
    return Scaffold(
      ...
      body: Obx(
        () => _con.isLoading.value
            ...
            : _con.admissionRegistrationList.isEmpty
                ? CU.getNodataDesign()
                : ListView.separated(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 20, vertical: 20),
                    itemCount: _con.admissionRegistrationList.length,
                    separatorBuilder: (context, index) => hSizeBox16,
                    itemBuilder: (context, index) {
                      var admissionConfirmation =
                          _con.admissionRegistrationList[index];
                      return Container(
                            ...
                            Row(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Get.toNamed(
                                      AppRoutes.createAdmissionRegistration,
                                      arguments: [
                                        _con.data,
                                        _con.userInfo,
                                        true,
