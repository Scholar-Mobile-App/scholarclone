...
class AdminOutwardController extends GetxController {
  Content data = Get.arguments[0];
  Map<String, dynamic> userInfo = Get.arguments[1];

  RxBool isLoading = false.obs;

  RxList<Outward> outwardList = <Outward>[].obs;
  ...
  Future<void> callOutwardService() async {
    ...
    if (await CU.checkInternet()) {
      resJson = await ApiClient.call(
        ...
        apiUrl:
            "https://erp.triz.co.in/inward_outward/add_outward?type=API&sub_institute_id=${userInfo[CS.sub_institute_id]}&syear=${userInfo[CS.syear]}&token=${userInfo[CS.token]}",
