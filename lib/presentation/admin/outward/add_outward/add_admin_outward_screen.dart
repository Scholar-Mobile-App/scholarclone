...
class AddAdminOutwardScreen extends StatelessWidget {
  AddAdminOutwardScreen({super.key});

  final AddAdminOutwardController _controller =
      Get.put(AddAdminOutwardController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbar(_controller.isEdit ? "Update Outward" : "Add Outward"),
      body: Obx(
        () => ListView(
