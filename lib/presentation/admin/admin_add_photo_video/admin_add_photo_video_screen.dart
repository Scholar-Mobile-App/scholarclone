...
import 'admin_add_photo_video_controller.dart';

class AdminAddPhotoVideoScreen extends StatelessWidget {
  AdminAddPhotoVideoScreen({super.key});
  final AdminAddPhotoVideoController _controller =
      Get.put(AdminAddPhotoVideoController());
