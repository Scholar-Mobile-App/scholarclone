...
class AdminSendEmailController extends GetxController {
  ...
  Future<void> callServiceSendNoti(context) async {
    ...
    Map<String, dynamic> body = <String, dynamic>{
      ...
      "all_email": studentEmail.value,
      "example-subject": subject.value,
    ...
    if (await CU.checkInternet()) {
      resJson = await ApiClient.call(
        context,
        body: body,
        apiUrl: "https://erp.triz.co.in/add_adminSendEmailAPI",
        isShowProgressDialog: false,
      );
    } else {
