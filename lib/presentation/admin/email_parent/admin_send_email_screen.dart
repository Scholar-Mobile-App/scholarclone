...
import 'admin_send_email_controller.dart';

class AdminSendEmailScreen extends StatelessWidget {
  AdminSendEmailScreen({super.key});
  final AdminSendEmailController _controller =
      Get.put(AdminSendEmailController());
