...
import 'package:scholar_clone/presentation/admin/admin_own_profile/admin_own_profile_controller.dart';
...
class AdminOwnProfileScreen extends StatelessWidget {
  ...
  final AdminOwnProfileController _controller =
      Get.put(AdminOwnProfileController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: teacherAppBar(text: "Own Profile"),
      body: Stack(
        children: [
          Container(
            width: Get.width,
