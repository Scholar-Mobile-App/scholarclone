...
import 'admin_add_circular_controller.dart';

class AdminAddCircularScreen extends StatelessWidget {
  AdminAddCircularScreen({super.key});
  final AdminAddCircularController _controller =
      Get.put(AdminAddCircularController());
