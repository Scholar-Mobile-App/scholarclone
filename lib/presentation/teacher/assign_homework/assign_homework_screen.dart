...
class AssignHomeWorkScreen extends StatelessWidget {
  ...
  final AssignHomeworkController _controller =
      Get.put(AssignHomeworkController());
  ...
  profile(Student studentList, int index) {
    return Obx(
      () => Row(
  ...
  Widget selectData() {
    return Container(
      ...
      child: Column(
        children: [
          if (_controller.userInfo["user_profile_name"] == "Admin")
            dropDownTextField(
              ...
              onChanged: (value) async {
                for (var i = 0;
                  ...
                  if (_controller.sectionModel!.data![i].shortName == value) {
                    ...
                    if (_controller.userInfo["user_profile_name"] == "Admin") {
                      await _controller
                          .callServiceStandard(_controller.sectionID.value);
                    }
                  }
                }
              },
          ...
          dropDownTextField(
            ...
            onChanged: (value) {
              for (int i = 0;
                  ...
                  i++) {
                if (_controller.divisionModel!.data![i].divName == value) {
          ...
          dropDownTextField(
            ...
            onChanged: (value) {
              for (int i = 0;
                  ...
                  i++) {
                if (_controller.teacherSubjectModel!.data![i].subName ==
                    value) {
                  _controller.subjectId.value =
                      _controller.teacherSubjectModel!.data![i].subId!;

                  _controller.selectSubject.value =
                      _controller.teacherSubjectModel!.data![i].subName!;
                  break;
                }
              }
            },
