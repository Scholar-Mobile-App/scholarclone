...
import 'package:scholar_clone/presentation/teacher/t_virtual_classroom/t_virtual_classroom_controller.dart';
...
class TeacherVirtualClassroomScreen extends StatelessWidget {
  TeacherVirtualClassroomScreen({super.key});
  final TeacherVirtualClassroomController _controller =
      Get.put(TeacherVirtualClassroomController());
