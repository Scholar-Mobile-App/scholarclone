...
import 't_subject_details_controller.dart';
...
class TeacherLMSChapteDetailScreen extends StatelessWidget {
  TeacherLMSChapteDetailScreen({super.key});
  final TeacherLMSChapteDetailController _controller =
      Get.put(TeacherLMSChapteDetailController());
